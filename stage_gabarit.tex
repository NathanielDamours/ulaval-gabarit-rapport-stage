...
\begin{figure}[h!]
	...
	\end{center}
  \caption{INVALIDE, VOIR COMMENTAIRES\cite{howard2020deep}}  % « Tu dois faire figurer le lien directement dans la légende de l'image. » (Adjoint à la coordination des stages), ce que je ne suis pas arrivé à faire.
  \label{fig:fastbook}
\end{figure}
